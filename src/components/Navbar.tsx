...
export const Navbar: React.FC<Props> = React.memo(({
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-[linear-gradient(180deg,rgba(5,7,13,0.96),rgba(7,10,18,0.88))] backdrop-blur-xl border-b border-white/10 text-white transition-all">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 flex items-center justify-between gap-2 border-b border-white/5 text-xs">
          <div className="flex items-center gap-3 sm:gap-5 shrink-0">
            <div className="flex items-center gap-2 sm:gap-3 cursor-pointer group" onClick={() => setActiveTab('dashboard')}>
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl border border-cyan-500/25 bg-cyan-500/10 flex items-center justify-center shadow-[0_4px_20px_rgba(6,182,212,0.12)] group-hover:border-cyan-400/40 transition">
            ...
            <div className="hidden md:flex items-center gap-2 bg-white/[0.04] border border-white/10 rounded-full px-3.5 py-1 text-xs">
          ...
          <div className="flex items-center gap-2 sm:gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-1 text-amber-400 font-mono font-bold bg-amber-950/20 border border-amber-500/20 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs">
              <Flame className="w-3.5 h-3.5 fill-amber-400" />
              <span>{user.streak}D</span>
            </div>

            <div className="flex items-center gap-1 text-yellow-500 font-mono font-bold bg-white/[0.04] border border-white/10 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs">
            ...
            <div className="flex items-center gap-1.5">
              <button
                onClick={onOpenCoach}
                className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[linear-gradient(135deg,rgba(91,33,182,0.24),rgba(30,41,59,0.72))] border border-violet-500/25 text-violet-100 hover:text-white transition cursor-pointer"
              ...
              <button
                ...
                className="hidden sm:block p-1.5 sm:p-2 rounded-lg bg-white/[0.04] border border-white/10 text-zinc-300 hover:bg-white/[0.08] transition cursor-pointer"
              ...
              <button
                ...
                className="p-1.5 sm:p-2 rounded-lg bg-white/[0.04] border border-white/10 text-zinc-300 hover:bg-white/[0.08] transition cursor-pointer"
              ...
              {onLogout && (
                <button
                  onClick={onLogout}
                  className="hidden md:block p-2 rounded-lg bg-red-950/30 border border-red-500/20 text-red-400 hover:bg-red-900/40 hover:text-red-200 transition cursor-pointer"
